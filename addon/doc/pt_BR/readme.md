...
Bem-vindo ao complemento de Acesso Remoto do NVDA, que permitirá a você se conectar a outro computador que esteja executando o leitor de tela NVDA livre. Não faz diferença se você está do outro lado da sala ou do outro lado do mundo. Conectar-se é simples, e existem muito poucos comandos para se lembrar. Você pode se conectar ao computador de outra pessoa, ou permitir que uma pessoa de confiança se conecte ao seu sistema para executar manutenção de rotina, diagnosticar um problema ou fornecer treinamento.

##Antes de você começar

Você precisa ter instalado NVDA em ambos os computadores, e obter o complemento acesso remoto NVDA.
A instalação de ambos NVDA e o complemento acesso remoto são padrão. Se precisar de mais informações, isso pode ser encontrado no Manual do Usuário do NVDA.

##Iniciando uma sessão remota através de um servidor de retransmissão
###Computador a ser controlado
