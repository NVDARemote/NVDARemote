...
class SlaveSession(RemoteSession):
	...
	def __init__(self, *args: Any, **kwargs: Any) -> None:
		...
		#self.transport.callback_manager.registerCallback('msg_client_joined', self.handleClientConnected)
		self.transport.registerInbound(RemoteMessageType.client_joined, self.handleClientConnected)
		#self.transport.callback_manager.registerCallback('msg_client_left', self.handleClientDisconnected)
		self.transport.registerInbound(RemoteMessageType.client_left, self.handleClientDisconnected)
		#self.transport.callback_manager.registerCallback('msg_key', self.localMachine.sendKey)
		...
		#self.transport.callback_manager.registerCallback('msg_index', self.recvIndex)
		...
		#self.transport.callback_manager.registerCallback('msg_channel_joined', self.handleChannelJoined)
		self.transport.registerInbound(RemoteMessageType.channel_joined, self.handleChannelJoined)
		# self.transport.callback_manager.registerCallback('msg_set_clipboard_text', self.localMachine.setClipboardText)
		...
		# self.transport.callback_manager.registerCallback('msg_braille_input', self.localMachine.brailleInput)
		self.transport.registerInbound(RemoteMessageType.braille_input, self.localMachine.brailleInput)
		# self.transport.callback_manager.registerCallback('msg_send_SAS', self.localMachine.sendSAS)
...
class MasterSession(RemoteSession):
	...
	def __init__(self, *args: Any, **kwargs: Any) -> None:
		...
		self.patchCallbacksAdded = False
		# self.transport.callback_manager.registerCallback('msg_speak', self.localMachine.speak)
		self.transport.registerInbound(RemoteMessageType.speak, self.localMachine.speak)
		# self.transport.callback_manager.registerCallback('msg_cancel', self.localMachine.cancelSpeech)
		self.transport.registerInbound(RemoteMessageType.cancel, self.localMachine.cancelSpeech)
		# self.transport.callback_manager.registerCallback('msg_pause_speech', self.localMachine.pauseSpeech)
		self.transport.registerInbound(RemoteMessageType.pause_speech, self.localMachine.pauseSpeech)
		# self.transport.callback_manager.registerCallback('msg_tone', self.localMachine.beep)
		self.transport.registerInbound(RemoteMessageType.tone, self.localMachine.beep)
		# self.transport.callback_manager.registerCallback('msg_wave', self.handlePlayWave)
		self.transport.registerInbound(RemoteMessageType.wave, self.handlePlayWave)
		# self.transport.callback_manager.registerCallback('msg_display', self.localMachine.display)
		...
		# self.transport.callback_manager.registerCallback('msg_client_left', self.handleClientDisconnected)
		self.transport.registerInbound(RemoteMessageType.client_left, self.handleClientDisconnected)
		# self.transport.callback_manager.registerCallback('msg_channel_joined', self.handleChannel_joined)
		self.transport.registerInbound(RemoteMessageType.channel_joined, self.handleChannel_joined)
		# self.transport.callback_manager.registerCallback('msg_set_clipboard_text', self.localMachine.setClipboardText)
		self.transport.registerInbound(RemoteMessageType.set_clipboard_text, self.localMachine.setClipboardText)
		# self.transport.callback_manager.registerCallback('msg_send_braille_info', self.sendBrailleInfo)
